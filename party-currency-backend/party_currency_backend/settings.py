...
SECRET_KEY = 'django-insecure-9p@local-dev-only-123456789'
...
DATABASES = {
    'default': {
        ...
        'USER': os.getenv('PGUSER', 'partyuser'),
        'PASSWORD': os.getenv('PGPASSWORD', 'psdevop'),
...
DEBUG = os.getenv('DEBUG')  # Only for debugging on Railway
